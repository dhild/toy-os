...
STANDALONE_FLAGS = -nostdlib -fno-builtin -nostartfiles -nodefaultlibs
CONVENTION_FLAGS = -m64 -fno-exceptions -fno-stack-protector -mno-red-zone
CFLAGS = $(WARNING_FLAGS) $(STANDALONE_FLAGS) $(CONVENTION_FLAGS) -g
